...
SFT_MERGED_PATH = os.path.join(_merge_models, f"{SELECT_MODEL}-sft-merged")   # sft/train_finance_mac.py 自动 merge 输出
OUTPUT_DIR      = os.path.join(_new_models, f"checkpoints/{SELECT_MODEL}-dpo-hh-merged-lora")
FINAL_OUTPUT    = os.path.join(_new_models, f"{SELECT_MODEL}-dpo-hh-merged-final")
